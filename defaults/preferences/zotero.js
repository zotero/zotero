...
pref("extensions.zotero.export.quickCopy.wrapCitationHtml", '<a href="zotero://select/items/%%ITEM_ID%%">{|%%STRING%% | %%LOCATOR%% | %%SUFFIX%%}</a>');
pref("extensions.zotero.export.quickCopy.wrapCitationText", '{|%%STRING%% | %%LOCATOR%% | %%SUFFIX%% | zotero://select/items/%%ITEM_ID%%}');
