describe("Item pane", function () {
	...
	describe("Batch Edit", function () {
		it("should enter and exit batch edit mode", async function () {
			...
			// Header should hide title-head and show batch edit controls
			...
			assert.ok(header.querySelector('#item-pane-batch-editing-disable'), "batch edit exit button should be in header");
