...
FW.Scraper({
  ...
  extra            : FW.Xpath('//div[@id="media-items"]').text().remove(/\[object XrayWrapper \[object HTMLDivElement\]\]/),
  ...
  tags             : FW.Xpath('//div[@id="cable-body"]/a').text().remove(/\]/).remove(/\[/).trim(),
