{
        ...
        "inRepository": true,
        "translatorType": 4,
        "lastUpdated": "2011-06-15 10:16:53"
}
...
FW.Scraper({
itemType         : 'webpage',
detect           : FW.Xpath('//div[@id="floatingmod"]/h1'),
title            : FW.Xpath('//div[@id="floatingmod"]/h1').text().trim(),
attachments      : [{ url: FW.Url().remove(/\?(.*)/).remove(/full\//).append("full\/"),
  title:  "Daily Beast Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//div[@class="author1"]//a[@class="author-link-black"]')
                    .text().replace(/\s/," ").cleanAuthor("author"),
date             : FW.Xpath('//div[@class="timestamp"]').text().replace(/\|/,"").trim(),
tags             : FW.Xpath('//div[@class="relatedsearches"]/a').text(),
abstractNote     : FW.Xpath('//span[@class="articlebyline"]').text(),
...
choices          : {
  titles :  FW.Xpath('//div[@class="entry"]/h1/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="entry"]/h1/a').key("href")
}
});
...
var testCases = [
    {
        "type": "web",
        "url": "http://www.thedailybeast.com/blogs-and-stories/2011-06-13/michele-bachmann-for-president-2012-she-grabs-nh-gop-debate-spotlight/",
        "items": [
            {
                "itemType": "webpage",
                "creators": [
                ...
                "attachments": [
                    {
                        "url": "http://www.thedailybeast.com/blogs-and-stories/2011-06-13/michele-bachmann-for-president-2012-she-grabs-nh-gop-debate-spotlight/full/",
                        "title": "Daily Beast Snapshot",
                        "type": "text/html"
                    }
                ],
                "url": "http://www.thedailybeast.com/blogs-and-stories/2011-06-13/michele-bachmann-for-president-2012-she-grabs-nh-gop-debate-spotlight/",
                "abstractNote": "The congresswoman used her bluntness and charm to overshadow the men at the GOP debate—announcing her presidential bid and passionately defending the Tea Party. Howard Kurtz on why she shouldn’t be underestimated.",
                "date": "June 13, 2011  11:35pm",
                "publicationTitle": "The Daily Beast",
                "title": "Michele Bachmann Grabs GOP Presidential Debate Spotlight",
