...
REPLACE INTO version VALUES ('repository', STRFTIME('%s', '2007-12-22 20:30:00'));
...
REPLACE INTO translators VALUES ('3e684d82-73a3-9a34-095f-19b112d88bbf', '1.0.0b3.r1', '', '2007-12-22 20:30:00', '1', '100', '4', 'Google Books', 'Simon Kornblith', '^http://books\.google\.[a-z]+(\.[a-z]+)?/books\?(.*id=.*|.*q=.*)', 
'function detectWeb(doc, url) {
