...
reader-highlight-text = Виділити текст
reader-underline-text = Underline Text
reader-add-note = Додати примітку
...
reader-read-aloud-error-unknown = Виникла невідома помилка.
...
reader-read-aloud-annotation-popup-delete = Видалити
...
reader-read-aloud-annotation-popup-underline = Підкреслення
