...
search-conditions-titleCreatorYear = Заголовок, Автор, Рік
search-conditions-submenu-attachment = Вкладення
search-conditions-submenu-annotation = Анотація
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Тип файлу
...
mac-word-plugin-install-folder-dialog-button = Встановити
...
save-search-edit-button =
    .label = Зберегти
save-search-name-title = Зберегти пошук
...
undo-action-edit-note = Редагувати примітку
...
undo-action-change-type = Змінити тип документу
