...
import-online-relink-kb = Додаткова інформація
...
rtfScan-input-file = Вхідний файл
rtfScan-output-file = Вихідний файл
...
integration-prefs-endnotes =
    .label = Кінцеві виноски
integration-prefs-bookmarks =
    .label = Store citation as bookmarks
integration-prefs-bookmarks-description = Закладки можна поширювати між Word та LibreOffice, але це може викликати помилки в разі випадкого редагування та неможливість вставки у виноски.
...
integration-prefs-automaticJournalAbbeviations =
    .label = Використовувати абревіатуру журналу в MEDLINE
