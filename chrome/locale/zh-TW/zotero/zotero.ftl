...
search-conditions-titleCreatorYear = 標題，創作者，年
search-conditions-submenu-attachment = 附件檔
search-conditions-submenu-annotation = 標註
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = 檔案類型
...
search-conditions-short-annotationType = 類型
...
mac-word-plugin-install-folder-dialog-button = 安裝
...
undo-action-rename-collection = 重命名文獻集
...
undo-action-change-type = 改變項目類型
