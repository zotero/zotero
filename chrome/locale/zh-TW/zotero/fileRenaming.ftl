...
file-renaming-file-types = 重新命名這些類型的檔案
...
file-renaming-rename-linked =
    .label = 重新命名連結的檔案
file-renaming-format-title = 檔案名稱格式
file-renaming-format-instructions = 您可以自定義檔案名稱模式，{ -app-name } 根據此模式從父項目屬性資料重新命名附件檔案。
...
file-renaming-format-instructions-more = 請參閱<label data-l10n-name="file-renaming-format-help-link">文件</label>以獲得更多資訊。
file-renaming-format-template = 檔案名稱模板：
file-renaming-format-preview = 預覽:
...
file-renaming-preview-window =
    .title = Rename Files
file-renaming-preview-window-loading = 載入中……
