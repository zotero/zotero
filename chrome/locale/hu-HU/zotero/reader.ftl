reader-annotations = Jegyzetek
reader-show-annotations = Jegyzetek mutatása
reader-search-annotations = Jegyzetek keresése
reader-search-outline = Search Outline
reader-no-annotations = Jegyzetek megjelenítése az oldalsávon
reader-no-extracted-text = No extracted text
reader-add-comment = Megjegyzés hozzáadása
...
reader-thumbnails = Bélyegképek
reader-tag-selector-message = Filter annotations by this tag
reader-add-tags = Címkék hozzáadása…
reader-highlight-text = Szöveg kiemelése
reader-underline-text = Szöveg aláhúzása
reader-add-note = Jegyzet hozzáadása
reader-add-text = Szöveg hozzáadása
reader-select-area = Terület kijelölése
reader-highlight-annotation = Megjegyzés kiemelése
reader-highlight-annotation-short = Highlight
reader-underline-annotation = Megjegyzés aláhúzása
reader-underline-annotation-short = Aláhúzás
reader-note-annotation = Jegyzet hozzáadása
reader-note-annotation-short = Jegyzet
reader-text-annotation = Text Annotation
reader-text-annotation-short = Text
reader-image-annotation = Image Annotation
reader-image-annotation-short = Kép
...
reader-draw = Rajzolás
reader-eraser = Eraser
reader-pick-color = Szín kiválasztása
reader-add-to-note = Jegyzethez adás
reader-zoom-in = Nagyítás
reader-zoom-out = Kicsinyítés
reader-zoom-reset = Nagyítás visszaállítása
reader-zoom-auto = Automatikus átméretezés
reader-zoom-page-width = Nagyítás oldalszélességre
reader-zoom-page-height = Teljes oldal
reader-split-vertically = Függőlegesen osztva
reader-split-horizontally = Vízszintesen osztva
reader-next-page = Következő oldal
reader-previous-page = Előző oldal
reader-page = Oldal
reader-location = Location
reader-read-only = Csak olvasható
reader-prompt-transfer-from-pdf-title = Jegyzetek importálása
reader-prompt-transfer-from-pdf-text = Annotations stored in the PDF file will be moved to { $target }.
reader-prompt-password-protected = A művelet nem támogatott a jelszóval védett PDF-fájlok esetében.
reader-prompt-delete-pages-title = Oldalak törlése
...
reader-rotate-left = Elforgatás balra
reader-rotate-right = Elforgatás jobbra
reader-edit-page-number = Oldalszám szerkesztése…
reader-edit-annotation-text = Megjegyzés szövegének szerkesztése
reader-copy-image = Kép mentése
reader-save-image-as = Kép mentése másként…
reader-page-number-popup-header = Oldalszám megváltoztatása:
reader-this-annotation = Ehhez a jegyzethez
reader-selected-annotations = Kijelölt jegyzetek
reader-this-page = Ez az oldal
reader-this-page-and-later-pages = Ez az oldal és a következő oldalak
reader-all-pages = Összes oldal
reader-auto-detect = Automatikus felismerés
reader-enter-password = Adja meg a jelszót a PDF fájl megnyitásához
reader-include-annotations = Include annotations
reader-preparing-document-for-printing = A dokumentum nyomtatásra való előkészítése...
reader-phrase-not-found = A kifejezés nem található
reader-find = Keresés
reader-close = Bezárás
reader-show-thumbnails = Bélyegképek megjelenítése
reader-show-outline = Vázlat megjelenítése
reader-find-previous = Find the previous occurrence of the phrase
reader-find-next = Find the next occurrence of the phrase
reader-toggle-sidebar = Oldalsáv megjelenítése/elrejtése
reader-find-in-document = Keresés a dokumentumban
reader-toggle-context-pane = Toggle Context Pane
reader-highlight-all = Összes kiemelése
...
reader-epub-appearance-use-original-font = Eredeti betűtípus használata
...
reader-size = Méret
reader-merge = Merge
reader-copy-link = Link másolása
reader-theme-original = Original
reader-theme-snow = Snow
reader-theme-sepia = Sepia
reader-theme-dark = Sötét
reader-theme-black = Fekete
...
reader-none = Egyik sem
reader-odd = Odd
reader-even = Even
reader-paginated = Oldalszámozás
...
reader-a11y-move-annotation = A megjegyzés mozgatásához használja a nyilakat a billentyűzetén.
...
reader-a11y-resize-annotation = A megjegyzés méretének módosításához tartsa lenyomva a { general-key-shift } billentyűt, és használja a nyílbillentyűket.
reader-a11y-annotation-popup-appeared = A Tab billentyűvel navigálhat a felugró megjegyzések között.
reader-a11y-annotation-created = { $type } létrehozva.
reader-a11y-annotation-selected = { $type } kiválasztva.
...
-reader-a11y-annotation-instruction = A megjegyzés hozzáadásához fókuszáljon a dokumentumra, és nyomja meg a { general-key-control }-{ option-or-alt }-{ $number }.
...
reader-toolbar-draw =
    .aria-description = Ez a megjegyzés típus nem hozható létre a billentyűzeten keresztül.
    .title = { reader-draw }
...
reader-import-from-epub =
    .label = Ebook megjegyzések importálása…
reader-import-from-epub-prompt-title = Ebook megjegyzések importálása
...
reader-import-from-epub-no-annotations-current-file =
    Úgy tűnik, hogy ez az ebook nem tartalmaz importálható megjegyzéseket.
    
    { -app-name } importálhatja a Calibre és a KOReader alkalmazásban létrehozott ebook-jegyzeteket.
...
reader-import-from-epub-select-other = Válassz másik fájlt…
...
reader-read-aloud-options = Beállítások
...
reader-read-aloud-voice-tier-standard = Alapértelmezett
reader-read-aloud-voice-tier-premium = Premium
reader-read-aloud-more-voices = More Voices…
reader-read-aloud-language = Nyelv
...
reader-read-aloud-error-unknown = Ismeretlen hiba.
...
reader-read-aloud-region-auto = Automatikus
...
reader-read-aloud-annotation-popup-delete = Törlés
reader-read-aloud-annotation-popup-done = Rendben
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Aláhúzás
