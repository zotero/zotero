...
preferences-file-renaming-customize-button =
    .label = Egyedi fájlnévformátum megadása…
preferences-file-renaming-rename-now =
    .label = Rename Files…
preferences-file-renaming-format-title = Fájlnév formátuma
preferences-file-renaming-format-instructions = Testreszabhatja a { -app-name }-ban a fájlnévmintát, amelyet a mellékletfájlok átnevezéséhez használ az adott elem metaadatából.
...
preferences-file-renaming-format-template = Fájlnév sablon:
