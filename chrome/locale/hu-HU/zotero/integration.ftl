...
integration-citationDialog-section-selectedItems = Kiválasztott elemek
...
integration-citationDialog-preview-empty = Előnézet
...
integration-citationDialog-enter-to-add-item = Nyomja meg a { return-or-enter } billentyűt az elem idézethez adásához.
