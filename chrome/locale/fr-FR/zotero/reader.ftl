...
reader-annotation-comment = Commentaire de l'annotation
reader-annotation-text = Texte de l'annotation
...
reader-highlight-annotation-short = Surligner
reader-underline-annotation = Souligner l'annotation
reader-underline-annotation-short = Souligné
...
reader-toggle-sidebar = Masquer/afficher la barre latérale
...
reader-theme-black = Noir
reader-add-theme = Ajouter un thème
reader-theme-invert-images = Inverser les images
...
reader-reading-mode = Mode lecture
reader-reading-mode-not-supported = Le mode lecture n'est pas pris en charge dans ce document.
reader-clear-selection = Effacer la sélection
reader-epub-encrypted = Ce livre numérique est crypté et ne peut pas être ouvert.
...
reader-read-aloud = Lire à haute voix
reader-read-aloud-from-here = Lire à haute voix à partir d'ici
reader-read-aloud-options = Options
reader-read-aloud-skip-back = Retour rapide
reader-read-aloud-skip-back-sentence = Retour rapide par phrase
reader-read-aloud-skip-ahead = Avance rapide
reader-read-aloud-skip-ahead-sentence = Avance rapide par phrase
reader-read-aloud-add-annotation = Annoter la phrase ({ $key1 }/{ $key2 })
reader-read-aloud-play = Lecture
reader-read-aloud-pause = Pause
reader-read-aloud-speed = Vitesse de lecture
reader-read-aloud-voice = Voix
reader-read-aloud-voice-tier = Mode de voix
reader-read-aloud-voice-tier-local = Local
reader-read-aloud-voice-tier-standard = Norme
reader-read-aloud-voice-tier-premium = Premium
reader-read-aloud-more-voices = Plus de voix...
reader-read-aloud-language = Langue
reader-read-aloud-remaining-time = Temps de lecture restant
reader-read-aloud-log-in-link = <log-in>Connectez-vous</log-in> pour accéder aux voix de { -app-name }.
reader-read-aloud-log-in-button = Se connecter
reader-read-aloud-done-button = { general-done }
reader-read-aloud-add-more-time = Ajouter plus de temps
reader-read-aloud-quota-exceeded-message =
    <add-more-time>{ reader-read-aloud-add-more-time }</add-more-time> ou continuer la lecture avec { $tier ->
...
reader-read-aloud-error-connection = Impossible de se connecter au service de lecture à haute voix. Veuillez vérifier votre connexion Internet.
...
reader-read-aloud-first-run-title = Choisissez la voix de lecture à voix haute que vous préférez :
reader-read-aloud-first-run-voice-tier-local-bullet-os-provided = Voix fournies par votre système d'exploitation
reader-read-aloud-first-run-voice-tier-local-bullet-offline = Disponible sans connexion Internet
reader-read-aloud-first-run-voice-tier-local-bullet-no-account = Disponible sans compte { -app-name }
reader-read-aloud-first-run-voice-tier-local-bullet-free = Utilisation gratuite
reader-read-aloud-first-run-voice-tier-standard-bullet-natural-sounding = Voix au son naturel
reader-read-aloud-first-run-voice-tier-standard-bullet-online-only = Disponible seulement avec une connexion Internet
reader-read-aloud-first-run-voice-tier-standard-bullet-account-required = Nécessite un compte { -app-name }
reader-read-aloud-first-run-voice-tier-standard-bullet-limited-languages = Choix de langues limité
reader-read-aloud-first-run-voice-tier-standard-bullet-no-multilingual = Multilinguisme non pris en charge
reader-read-aloud-first-run-voice-tier-standard-bullet-internal-processing = Le texte source ne quitte pas les serveurs de { -app-name }
reader-read-aloud-first-run-voice-tier-standard-bullet-unlimited-with-subscription = Utilisation illimitée avec un abonnement { -subscription-name }
reader-read-aloud-first-run-voice-tier-premium-bullet-highest-quality = Voix de très haute qualité
reader-read-aloud-first-run-voice-tier-premium-bullet-online-only = Disponible seulement avec une connexion Internet
reader-read-aloud-first-run-voice-tier-premium-bullet-account-required = Nécessite un compte { -app-name }
reader-read-aloud-first-run-voice-tier-premium-bullet-broad-languages = Large choix de langues
reader-read-aloud-first-run-voice-tier-premium-bullet-multilingual = Prise en charge du multilinguisme
reader-read-aloud-first-run-voice-tier-premium-bullet-external-processing = Le texte source est traité par des fournisseurs externes de synthèse vocale
reader-read-aloud-first-run-voice-tier-premium-bullet-subscription-minutes = Les forfaits { -subscription-name } comprennent des minutes de voix Premium mensuelles
reader-read-aloud-first-run-voice-tier-premium-bullet-beta-credits = Demander des crédits pour obtenir des minutes supplémentaires pendant la phase bêta
reader-read-aloud-sample-text = Je suis la voix locale { $name }
reader-read-aloud-voices-none-available = Aucune voix disponible
reader-read-aloud-first-run-no-voices-for-language = Les voix { $tier } ne prennent pas en charge le { $language }.
reader-read-aloud-region = Région
reader-read-aloud-region-auto = Automatique
reader-read-aloud-annotation-popup-move = Déplacer l'annotation phrase par phrase
reader-read-aloud-annotation-popup-extend = Etendre l'annotation phrase par phrase
reader-read-aloud-annotation-popup-delete = Supprimer
reader-read-aloud-annotation-popup-done = Terminé
reader-read-aloud-annotation-popup-change-color = Changer la couleur
reader-read-aloud-annotation-popup-highlight = Surligner
reader-read-aloud-annotation-popup-underline = Souligné
