...
file-renaming-invalid-template-prompt-title = Modèle de nom de fichier invalide
file-renaming-invalid-template-prompt-body = Le modèle de nom de fichier comporte une erreur de syntaxe et ne peut pas être enregistré. Voulez-vous revenir au modèle par défaut?
file-renaming-invalid-template-prompt-body-library = Le modèle de nom de fichier pour “{ $library }” comporte une erreur de syntaxe et ne peut pas être enregistré. Voulez-vous revenir au modèle par défaut?
