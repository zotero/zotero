...
reader-add-comment = Lisa kommentaar
...
reader-thumbnails = Pisipildid
reader-tag-selector-message = Filter annotations by this tag
reader-add-tags = Lisa sildid...
reader-highlight-text = Teksti esiletõstmine
reader-underline-text = Allajoonitud tekstid
reader-add-note = Märkuse lisamine
reader-add-text = Lisa tekst
reader-select-area = Valiala
...
reader-draw = Joonista
reader-eraser = Kustutaja
reader-pick-color = Vali värv
reader-add-to-note = Lisa märkus
...
reader-next-page = Järgmine lehekülg
reader-previous-page = Eelmine lehekülg
reader-page = Lehekülg
reader-location = Asukoht
...
reader-rotate-left = Pööra vasakule
reader-rotate-right = Pööra paremale
reader-edit-page-number = Muuda lehekülje numbrit...
reader-edit-annotation-text = Edit Annotation Text
reader-copy-image = Kopeeri pilt
reader-save-image-as = Salvesta pilt kui...
...
reader-this-page = See lehekülg
reader-this-page-and-later-pages = This page and later pages
reader-all-pages = Kõik leheküljed
reader-auto-detect = Tuvasta automaatselt
...
reader-phrase-not-found = Fraasi ei leitud
reader-find = Otsida
reader-close = Sulge
reader-show-thumbnails = Näita pisipilte
...
reader-appearance = Välimus
reader-epub-appearance-line-height = Reakõrgus
reader-epub-appearance-word-spacing = Sõnade vahe
reader-epub-appearance-letter-spacing = Tähtede vahe
reader-epub-appearance-page-width = Lehe laius
...
reader-size = Suurus
reader-merge = Liida
reader-copy-link = Kopeeri link
reader-theme-original = Algne
reader-theme-snow = Lumi
reader-theme-sepia = Sepia
reader-theme-dark = Tume
reader-theme-black = Must
reader-add-theme = Lisa teema
reader-theme-invert-images = Invert Images
reader-scroll-mode = Kerimine
reader-spread-mode = Spreads
reader-flow-mode = Page Layout
reader-columns = Veerud
reader-split-view = Split View
reader-themes = Teemad
reader-vertical = Vertikaalne
reader-horizontal = Horisontaalne
...
reader-theme-name = Teema nimi:
reader-background = Taust:
...
reader-clear-selection = Tühjenda valik
...
reader-read-aloud-options = Valikud
...
reader-read-aloud-language = Keel
...
reader-read-aloud-error-unknown = Tundmatu viga.
...
reader-read-aloud-region-auto = Automaatne
...
reader-read-aloud-annotation-popup-delete = Kustutada
reader-read-aloud-annotation-popup-done = Valmis
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Allajoonitud
