...
collections-menu-rename =
    .label = Rename
edit-saved-search = Salvestatud otsingu toimetamine
...
search-conditions-submenu-attachment = Manus
search-conditions-submenu-annotation = Annotatsioon
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Faili tüüp
...
search-conditions-short-annotationType = Tüüp
...
attachment-storage-type-linkedFile = Lingitud fail
attachment-storage-type-webLink = Veebilink
...
mac-word-plugin-install-folder-dialog-button = Paigaldus
...
save-search-edit-button =
    .label = Salvesta
save-search-name-title = Otsing salvestada
...
undo-action-edit-note = Märkuse toimetamine
...
undo-action-change-type = Kirje tüübi muutmine
