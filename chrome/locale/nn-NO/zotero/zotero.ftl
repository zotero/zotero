...
collections-menu-rename =
    .label = Rename
edit-saved-search = Rediger lagra søk
...
search-conditions-short-annotationAuthor = Forfattar
...
attachment-storage-type-linkedFile = Lenka fil
...
save-search-edit-button =
    .label = Lagra
save-search-name-title = Lagra søk
...
undo-action-change-type = Endre type
