...
rtfScan-input-file = Fil å lesa
rtfScan-output-file = Fil å skriva
...
integration-prefs-bookmarks-description = Bokmerke kan utvekslast mellom Microsoft Word og OpenOffice, men er utsette for utilsikta endringar. Dei kan ikkje plasserast i fotnotar.
...
integration-prefs-automaticJournalAbbeviations =
    .label = Bruk MEDLINE-journalforkortingar
