...
preferences-note-title = குறிப்புகள்
...
preferences-locate-resolver = தீர்வி:
...
-preferences-sync-data-syncing = தரவு ஒத்திசைவு
...
preferences-sync-settings-heading = ஒத்திசைவு
...
preferences-sync-reset-restore-to-server-yes = நிகழ்நிலை நூலகத்தில் தரவை மாற்றவும்
