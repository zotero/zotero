...
note-editor-paragraph = Đoạn văn
...
note-editor-highlight-text = Đánh dấu đoạn văn bản
note-editor-text-color = Text Color
note-editor-remove-color = Bỏ màu
note-editor-bold = Đậm
note-editor-italic = Nghiêng
note-editor-underline = Gạch dưới
note-editor-strikethrough = Strikethrough
note-editor-subscript = Chữ viết nhỏ ở dưới
note-editor-superscript = Chữ viết nhỏ ở trên
