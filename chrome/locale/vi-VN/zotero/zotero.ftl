...
collections-menu-rename =
    .label = Rename
edit-saved-search = Soạn thảo Tìm kiếm Định sẵn
...
search-conditions-submenu-attachment = Phần đính kèm
search-conditions-submenu-annotation = Ghi chú
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Kiểu Tập tin
...
search-conditions-short-annotationType = Kiểu
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = Tác giả
...
mac-word-plugin-install-folder-dialog-button = Cài đặt
...
save-search-edit-button =
    .label = Save
save-search-name-title = Ghi nhớ Tìm kiếm Định sẵn
...
undo-action-edit-note = Soạn thảo Ghi chép
...
undo-action-change-type = Đổi Kiểu cho Biểu ghi
