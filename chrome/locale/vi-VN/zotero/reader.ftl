...
reader-highlight-text = Đánh dấu đoạn văn bản
reader-underline-text = Underline Text
reader-add-note = Tạo một Ghi chép
...
reader-read-aloud-error-unknown = Đã có lỗi không rõ xảy ra.
...
reader-read-aloud-annotation-popup-delete = Xóa
reader-read-aloud-annotation-popup-done = Hoàn thành
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Gạch dưới
