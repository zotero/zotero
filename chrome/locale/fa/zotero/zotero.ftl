...
collections-menu-rename =
    .label = Rename
edit-saved-search = ویرایش جستجوی ذخیره شده
...
search-conditions-submenu-attachment = پیوست
search-conditions-submenu-annotation = حاشیه‌نویسی
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = نوع پرونده
...
search-conditions-short-annotationType = نوع
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = نویسنده
...
mac-word-plugin-install-folder-dialog-button = نصب
...
save-search-edit-button =
    .label = Save
save-search-name-title = ذخیره جستجو
...
undo-action-edit-note = ویرایش یادداشت
...
undo-action-change-type = تغییر نوع آیتم‌
