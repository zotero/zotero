...
note-editor-paragraph = پاراگراف
...
note-editor-highlight-text = پررنگ کردن متن
note-editor-text-color = Text Color
note-editor-remove-color = حذف رنگ
note-editor-bold = ضخیم
note-editor-italic = کج
note-editor-underline = خط زیر
note-editor-strikethrough = Strikethrough
note-editor-subscript = زیرنویس
note-editor-superscript = بالانویس
...
note-editor-image = تصویر
note-editor-math = Math
note-editor-table = Table
note-editor-citation = یادکرد
