...
preferences-file-renaming-format-title = Filnamnsformat
...
preferences-file-renaming-format-template = Filnamnsmall:
preferences-file-renaming-format-preview = Förhandsvisa:
