...
preferences-note-title = Oharrak
...
preferences-locate-resolver = Ebazlea:
...
-preferences-sync-data-syncing = Datuen sinkronizazioa
...
preferences-sync-settings-heading = Sinkronizatu
...
preferences-sync-reset-restore-to-server-yes = Ordezkatu datuak lineako liburutegian
