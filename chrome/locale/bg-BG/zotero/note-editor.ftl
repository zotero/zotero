...
note-editor-highlight-text = Акцентиране на текст
note-editor-text-color = Text Color
note-editor-remove-color = Премахване на цвят
note-editor-bold = Удебелен
note-editor-italic = Наклонен
note-editor-underline = Подчертан
note-editor-strikethrough = Strikethrough
note-editor-subscript = Субскрипт / Долни букви
note-editor-superscript = Суперскрипт / Горни букви
