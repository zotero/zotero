...
preferences-locate-resolver = Разрешаващ сървър - "резолвър" :
...
-preferences-sync-data-syncing = Синхронизиране на данни
...
preferences-sync-settings-heading = Синхронизиране
