...
collections-menu-rename =
    .label = Rename
edit-saved-search = Редактира записаното търсене
...
search-conditions-submenu-attachment = Приложение
search-conditions-submenu-annotation = Анотация
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Вид файл
...
search-conditions-short-annotationType = Вид
...
mac-word-plugin-install-folder-dialog-button = Инсталиране
...
save-search-edit-button =
    .label = Запазване
save-search-name-title = Запис на търсенето
...
undo-action-edit-note = Редактира бележка
...
undo-action-change-type = Променя типа на записа
