...
preferences-locate-resolver = 해독기:
...
-preferences-sync-data-syncing = 데이터 동기화
...
preferences-sync-settings-heading = 동기화
...
preferences-sync-reset-restore-to-server-yes = 온라인 라이브러리의 데이터 교체
