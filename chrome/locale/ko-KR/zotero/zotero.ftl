...
collections-menu-rename =
    .label = Rename
edit-saved-search = 저장된 검색 목록 편집
...
search-conditions-titleCreatorYear = 제목, 저자, 연도
search-conditions-submenu-attachment = 첨부
search-conditions-submenu-annotation = 주석
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = 파일 형식
...
search-conditions-short-annotationType = 형식
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = 저자
...
mac-word-plugin-install-folder-dialog-button = 설치
...
save-search-edit-button =
    .label = 저장
save-search-name-title = 검색결과 저장
...
undo-action-change-type = 항목 종류 변경
