...
reader-text-annotation-short = Testo
reader-image-annotation = Annotazione: immagine
reader-image-annotation-short = Immagine
reader-ink-annotation = Annotazione: scrittura a mano libera
reader-ink-annotation-short = A mano libera
...
reader-read-aloud-skip-back = Salta al paragrafo precedente
reader-read-aloud-skip-back-sentence = Salta alla frase precedente
reader-read-aloud-skip-ahead = Salta al paragrafo successivo
reader-read-aloud-skip-ahead-sentence = Salta alla frase successiva
...
reader-read-aloud-error-network = Impossibile connetersi al servizio di lettura. Si prega di verificare la connessione a Internet.
