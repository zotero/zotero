...
preferences-file-renaming-configure-button =
    .label = Configura rinominazione dei file...
...
preferences-read-aloud-title = Leggi ad alta voce
preferences-read-aloud-highlight-granularity = Evidenzia attuale
...
preferences-advanced-local-api-clear-authorizations =
    .label = Cancella autorizzazioni in scrittura
...
fulltext-index-status-indexing = Indicizzazione { $indexed } di { $total }…
fulltext-index-status-complete = L'indice di ricerca è aggiornato
fulltext-stats-attachments-indexed = Allegati indicizzati:
fulltext-stats-partially-indexed = Parzialmente indicizzati:
fulltext-stats-not-available = Contenuto o file full-text non disponibile:
fulltext-stats-notes-indexed = Note indicizzate:
