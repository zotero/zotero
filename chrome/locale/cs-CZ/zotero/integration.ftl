integration-docPrefs-window =
    .title = { -app-name } - Předvolby dokumentů
integration-addEditCitation-window =
    .title = { -app-name } - Přidat/upravit citaci
integration-editBibliography-window =
    .title = { -app-name } - Upravit bibliografii
...
-integration-editBibliography-include-uncited = Chcete-li do bibliografie zahrnout necitovanou položku, vyberte ji v seznamu položek a stiskněte tlačítko { general-add }.
-integration-editBibliography-exclude-cited = Citovanou položku můžete také vyloučit tak, že ji vyberete ze seznamu odkazů a stisknete tlačítko { general-remove }.
-integration-editBibliography-edit-reference = Chcete-li změnit formátování odkazu, použijte textový editor.
integration-editBibliography-wrapper =
    .aria-label = Dialog Upravit bibliografii
    .aria-description =
...
integration-citationDialog-section-selectedItems = Vybrané položky
...
integration-citationDialog-details-suppressAuthor = Vynechat autora
...
integration-citationDialog-preview-empty = Náhled
...
integration-prefs-bookmarks =
    .label = Uložit citace jako záložky
...
integration-prefs-bookmarks-formatNotice =
    { $show ->
        [true] Dokument musí být uložen ve formátu .doc nebo .docx.
       *[other] { "" }
    }
...
integration-error-unable-to-find-winword = { -app-name } se nepodařilo najít spuštěnou instanci aplikace Word.
