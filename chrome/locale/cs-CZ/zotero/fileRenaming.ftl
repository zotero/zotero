...
file-renaming-file-types = Přejmenovat soubory těchto typů:
...
file-renaming-rename-linked =
    .label = Přejmenovat propojené soubory
file-renaming-format-title = Formát názvu souboru
file-renaming-format-instructions = Můžete přizpůsobit vzor názvu souboru, který  { -app-name } používá k přejmenování souborů příloh z rodičovských metadat.
...
file-renaming-format-instructions-more = Viz <label data-l10n-name="file-renaming-format-help-link">dokumentace</label> pro více informací.
file-renaming-format-template = Šablona názvu souboru:
file-renaming-format-preview = Náhled:
...
file-renaming-preview-window =
    .title = Rename Files
file-renaming-preview-window-loading = Nahrává se...
