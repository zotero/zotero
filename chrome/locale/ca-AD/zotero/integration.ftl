...
integration-editBibliography-editor =
    .aria-label = Edita la referència
...
integration-citationDialog-section-selectedItems = Elements seleccionats
...
integration-citationDialog-preview-empty = Previsualització
...
integration-citationDialog-btn-type-citation =
    .title = Afegeix / Edita la cita
integration-citationDialog-btn-type-add-note =
    .title = Afegeix una nota
...
integration-prefs-bookmarks =
    .label = Emmagatzema la cita com a adreces d'interès
