...
collections-menu-rename =
    .label = Rename
edit-saved-search = Edita la cerca desada
...
search-conditions-titleCreatorYear = Títol, autor, any
search-conditions-submenu-attachment = Adjunció
search-conditions-submenu-annotation = Anotació
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Tipus de fitxer
...
search-conditions-short-annotationType = Tipus
...
attachment-storage-type-linkedFile = Fitxer enllaçat
attachment-storage-type-webLink = Enllaç web
...
mac-word-plugin-install-folder-dialog-button = Instal·la
...
save-search-edit-button =
    .label = Desa
save-search-name-title = Desa la cerca
...
undo-action-rename-collection = Reanomena la col·lecció
...
undo-action-edit-note = Edita la nota
...
undo-action-change-type = Canvia el tipus d'element
