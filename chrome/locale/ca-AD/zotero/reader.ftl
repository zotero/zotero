reader-annotations = Anotacions
reader-show-annotations = Mostra les anotacions
reader-search-annotations = Cerca anotacions
reader-search-outline = Esquema de cerca
reader-no-annotations = Creeu una anotació per a veure-la en la barra lateral
reader-no-extracted-text = Text no extret
reader-add-comment = Afegeix un comentari
reader-annotation-comment = Comentari de l'anotació
reader-annotation-text = Text de l'anotació
reader-manage-tags = Gestiona les etiquetes per a aquesta anotació
reader-open-menu = Obre el menú d'anotacions
reader-thumbnails = Miniatures
reader-tag-selector-message = Filtra les anotacions per aquesta etiqueta
reader-add-tags = Afegeix etiquetes…
reader-highlight-text = Marca el text
reader-underline-text = Text subratllat
reader-add-note = Afegeix una nota
reader-add-text = Afegeix text
reader-select-area = Selecciona l'àrea
reader-highlight-annotation = Marca l'anotació
reader-highlight-annotation-short = Highlight
reader-underline-annotation = Anotació de subratllat
reader-underline-annotation-short = Subratllat
reader-note-annotation = Note Annotation
reader-note-annotation-short = Nota
reader-text-annotation = Anotació de text
reader-text-annotation-short = Text
reader-image-annotation = Image Annotation
reader-image-annotation-short = Imatge
reader-ink-annotation = Ink Annotation
reader-ink-annotation-short = Ink
reader-search-result-index = Resultat de cerca
reader-search-result-total = Resultats de cerca totals
reader-draw = Dibuixa
reader-eraser = Esborrador
reader-pick-color = Tria un color
reader-add-to-note = Afegeix a la nota
reader-zoom-in = Amplia
reader-zoom-out = Redueix
reader-zoom-reset = Restableix el zoom
reader-zoom-auto = Redimensiona automàticament
reader-zoom-page-width = Ajusta a l'amplada de la pàgina
reader-zoom-page-height = Ajusta a l'alçada de la pàgina
reader-split-vertically = Divideix verticalment
reader-split-horizontally = Divideix horitzontalment
reader-next-page = Pàgina següent
reader-previous-page = Pàgina anterior
reader-page = Pàgina
reader-location = Localització
reader-read-only = Només de lectura
reader-prompt-transfer-from-pdf-title = Importa anotacions
reader-prompt-transfer-from-pdf-text = Annotations stored in the PDF file will be moved to { $target }.
reader-prompt-password-protected = L'operació no funciona en fitxers PDF protegits amb contrasenya.
reader-prompt-delete-pages-title = Elimina les pàgines
...
reader-rotate-left = Gira a l'esquerra
reader-rotate-right = Gira a la dreta
reader-edit-page-number = Edita el número de pàgina…
reader-edit-annotation-text = Edita el text de l'anotació
reader-copy-image = Copia la imatge
reader-save-image-as = Anomena i desa la imatge…
reader-page-number-popup-header = Canvia el número de la pàgina per:
reader-this-annotation = Aquesta anotació
reader-selected-annotations = Anotacions seleccionades
reader-this-page = Aquesta pàgina
reader-this-page-and-later-pages = Aquesta pàgina i posteriors
reader-all-pages = Totes les pàgines
reader-auto-detect = Detecció automàtica
reader-enter-password = Introduïu la contrasenya per a obrir aquest fitxer
reader-include-annotations = Inclou les anotacions
reader-preparing-document-for-printing = S'està preparant el document per a imprimir...
reader-phrase-not-found = No s'ha trobat la frase
reader-find = Cerca
reader-close = Tanca
reader-show-thumbnails = Mostra les miniatures
reader-show-outline = Mostra el contorn
reader-find-previous = Troba l'ocurrència anterior de la frase
reader-find-next = Troba l'ocurrència següent de la frase
reader-toggle-sidebar = Commuta la barra lateral
reader-find-in-document = Troba al document
reader-toggle-context-pane = Commuta la subfinestra contextual
reader-highlight-all = Ressalta-ho tot
reader-match-case = Coincidència entre majúscules i minúscules
reader-whole-words = Paraules senceres
reader-appearance = Aparença
reader-epub-appearance-line-height = Alçada de la línia
reader-epub-appearance-word-spacing = Espaiat entre paraules
reader-epub-appearance-letter-spacing = Espaiat entre lletres
reader-epub-appearance-page-width = Amplada de pàgina
reader-epub-appearance-use-original-font = Utilitza la lletra tipogràfica original
reader-epub-appearance-line-height-revert = Utilitza l'alçada de línia per defecte
reader-epub-appearance-word-spacing-revert = Utilitza l'espaiat entre paraules per defecte
reader-epub-appearance-letter-spacing-revert = Utilitza l'espaiat entre lletres per defecte
reader-epub-appearance-page-width-revert = Utilitza l'amplada de pàgina per defecte
reader-convert-to-highlight = Converteix a ressaltat
reader-convert-to-underline = Converteix a subratllat
reader-size = Mida
reader-merge = Fusiona
reader-copy-link = Copia l'enllaç
reader-theme-original = Original
reader-theme-snow = Neu
reader-theme-sepia = Sípia
reader-theme-dark = Fosc
reader-theme-black = Negre
reader-add-theme = Afegeix tema
reader-theme-invert-images = Invert Images
reader-scroll-mode = Desplaçament
reader-spread-mode = Disposicions
reader-flow-mode = Disposició de pàgina
reader-columns = Columnes
reader-split-view = Vista dividida
reader-themes = Temes
reader-vertical = Vertical
reader-horizontal = Horitzontal
reader-wrapped = Ajustat
reader-none = Cap
reader-odd = Senar
reader-even = Parell
reader-paginated = Paginat
reader-scrolled = Desplaçat
reader-single = Simple
reader-double = Doble
reader-theme-name = Nom del tema:
reader-background = Fons:
reader-foreground = Front:
reader-reading-mode = Mode de lectura:
reader-reading-mode-not-supported = Reading Mode is not supported in this document.
reader-clear-selection = Buida la selecció
...
reader-toolbar-draw =
    .aria-description = Aquest tipus d'anotació no es pot crear amb el teclat.
    .title = { reader-draw }
...
reader-read-aloud-options = Opcions
...
reader-read-aloud-error-unknown = S'ha produït un error desconegut.
...
reader-read-aloud-region-auto = Automàtic
...
reader-read-aloud-annotation-popup-delete = Suprimeix
reader-read-aloud-annotation-popup-done = Fet
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Subratllat
