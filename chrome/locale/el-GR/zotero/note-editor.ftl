...
note-editor-paragraph = Παράγραφος
...
note-editor-highlight-text = Υπογράμμιση κειμένου
note-editor-text-color = Text Color
note-editor-remove-color = Απομάκρυνση χρώματος
note-editor-bold = Έντονα
note-editor-italic = Πλάγια
note-editor-underline = Υπογραμμισμένα
note-editor-strikethrough = Strikethrough
note-editor-subscript = Δείκτης
note-editor-superscript = Εκθέτης
...
note-editor-image = Εικόνα
note-editor-math = Math
note-editor-table = Table
note-editor-citation = Παραπομπή
