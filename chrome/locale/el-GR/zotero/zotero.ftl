...
search-conditions-submenu-attachment = Συνημμένο
search-conditions-submenu-annotation = Annotation
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Τύπος Αρχείου
...
search-conditions-short-annotationType = Τύπος
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = Συγγραφέας
...
mac-word-plugin-install-folder-dialog-button = Εγκατάσταση
...
save-search-edit-button =
    .label = Αποθήκευση
save-search-name-title = Αποθήκευση αναζήτησης
...
undo-action-edit-note = Επεξεργασία Σημείωσης
...
undo-action-change-type = Αλλαγή Τύπου Στοιχείου
