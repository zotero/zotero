...
reader-annotation-text = 注釈テキスト
reader-manage-tags = この注釈のタグを管理
reader-open-menu = 注釈メニューを開く
reader-thumbnails = サムネイル
reader-tag-selector-message = このタグで注釈をフィルタリング
reader-add-tags = タグを追加
reader-highlight-text = テキストを強調表示
reader-underline-text = 下線付きテキスト
...
reader-draw = 描画
reader-eraser = 消しゴム
reader-pick-color = 色の取得
reader-add-to-note = メモに追加
reader-zoom-in = 拡大表示
reader-zoom-out = 縮小表示
reader-zoom-reset = 倍率をリセット
reader-zoom-auto = 自動的にサイズ変更
reader-zoom-page-width = ページ幅に合わせる
reader-zoom-page-height = ページの高さに合わせる
reader-split-vertically = 左右に分割
reader-split-horizontally = 上下に分割
...
reader-edit-page-number = ページ番号の編集…
reader-edit-annotation-text = 注釈テキストの編集
reader-copy-image = 画像をコピー
reader-save-image-as = ファイル形式を指定して画像を保存…
reader-page-number-popup-header = ページ番号の変更 :
...
reader-enter-password = この PDF ファイルを開くためのパスワードを入力してください
reader-include-annotations = 注釈を含める
reader-preparing-document-for-printing = 印刷のために文書を準備しています…
reader-phrase-not-found = フレーズが見つかりません
reader-find = 検索
reader-close = 閉じる
reader-show-thumbnails = サムネイルを表示
reader-show-outline = アウトラインを表示
reader-find-previous = フレーズの前の出現箇所を検索
reader-find-next = フレーズの次の出現箇所を検索
reader-toggle-sidebar = サイドバーの表示を切り替え
reader-find-in-document = ドキュメント内を検索
reader-toggle-context-pane = コンテキストパネルの切り替え
reader-highlight-all = すべて強調表示
reader-match-case = 大文字と小文字を区別
reader-whole-words = 単語全体
reader-appearance = 外観
reader-epub-appearance-line-height = 行の高さ
reader-epub-appearance-word-spacing = 単語間隔
reader-epub-appearance-letter-spacing = 文字間隔
reader-epub-appearance-page-width = ページ幅
reader-epub-appearance-use-original-font = オリジナルフォントを使用
reader-epub-appearance-line-height-revert = デフォルトの行の高さを使用
reader-epub-appearance-word-spacing-revert = デフォルトの単語間隔を使用
reader-epub-appearance-letter-spacing-revert = デフォルトの文字間隔を使用
reader-epub-appearance-page-width-revert = デフォルトのページ幅を使用
reader-convert-to-highlight = 強調表示に変換
reader-convert-to-underline = 下線に変換
reader-size = サイズ
reader-merge = 結合
reader-copy-link = リンクをコピー
reader-theme-original = オリジナル
reader-theme-snow = 雪
reader-theme-sepia = セピア
reader-theme-dark = ダーク
reader-theme-black = ブラック
reader-add-theme = テーマを追加
reader-theme-invert-images = 画像を反転
reader-scroll-mode = スクロール
reader-spread-mode = 見開きページ
reader-flow-mode = ページレイアウト
reader-columns = コラム
reader-split-view = 分割表示
reader-themes = テーマ
reader-vertical = 垂直方向
reader-horizontal = 水平方向
reader-wrapped = 折り返し
reader-none = なし
reader-odd = 奇数
reader-even = 偶数
reader-paginated = ページ送り
reader-scrolled = スクロール
reader-single = シングル
reader-double = ダブル
