...
file-renaming-file-types = Преименуј следеће врсте датотека:
...
file-renaming-rename-linked =
    .label = Преименуј повезане датотеке
file-renaming-format-title = Формат имена датотеке
file-renaming-format-instructions = Можете променити шаблон за име датотеке који { -app-name } користи да преименује датотеке са прилозима на основу метаподатака.
...
file-renaming-format-instructions-more = Погледајте <label data-l10n-name="file-renaming-format-help-link">документацију</label> за више података.
file-renaming-format-template = Шаблон за име датотеке:
file-renaming-format-preview = Преглед:
...
file-renaming-preview-window =
    .title = Rename Files
file-renaming-preview-window-loading = Учитавам…
