...
-preferences-sync-data-syncing = Synchronizácia dát
...
preferences-sync-settings-heading = Synchronizovať
...
preferences-sync-reset-restore-to-server-yes = Nahradiť dáta v online knižnici
