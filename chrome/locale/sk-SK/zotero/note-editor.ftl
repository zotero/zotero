...
note-editor-highlight-text = Zvýrazniť text
note-editor-text-color = Text Color
note-editor-remove-color = Odstrániť farbu
note-editor-bold = Tučné
note-editor-italic = Kurzíva
note-editor-underline = Podčiarknuté
note-editor-strikethrough = Strikethrough
note-editor-subscript = Dolný index
note-editor-superscript = Horný index
...
note-editor-edit-in-window = Upraviť v samostatnom okne
...
note-editor-image = Obrázok
note-editor-math = Math
note-editor-table = Table
note-editor-citation = Citácia
