...
reader-highlight-text = Zvýrazniť text
reader-underline-text = Underline Text
reader-add-note = Pridať poznámku
...
reader-underline-annotation-short = Podčiarknuté
...
reader-image-annotation-short = Obrázok
...
reader-zoom-in = Priblížiť
reader-zoom-out = Oddialiť
reader-zoom-reset = Reset Zoom
reader-zoom-auto = Automaticky upraviť veľkosť
reader-zoom-page-width = Prispôsobiť na šírku stránky
reader-zoom-page-height = Prispôsobiť na výšku stránky
...
reader-read-aloud-voice-tier-standard = Štandard
...
reader-read-aloud-region-auto = Automaticky
...
reader-read-aloud-annotation-popup-delete = Vymazať
...
reader-read-aloud-annotation-popup-underline = Podčiarknuté
