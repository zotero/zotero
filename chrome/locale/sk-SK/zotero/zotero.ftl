...
collections-menu-rename =
    .label = Rename
edit-saved-search = Upraviť uložené vyhľadávanie
...
search-conditions-titleCreatorYear = Titul, Autor, Rok
search-conditions-submenu-attachment = Príloha
search-conditions-submenu-annotation = Anotácia
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Typ súboru
...
search-conditions-short-annotationType = Druh rukopisu
...
mac-word-plugin-install-folder-dialog-button = Inštalovať
...
save-search-edit-button =
    .label = Uložiť
save-search-name-title = Uložiť vyhľadávanie
...
undo-action-edit-note = Upraviť poznámku
...
undo-action-change-type = Zmeniť typ záznamu
