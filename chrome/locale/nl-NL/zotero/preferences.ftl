...
preferences-note-title = Aantekeningen
...
-preferences-sync-data-syncing = Data-synchronisatie
...
preferences-sync-settings-heading = Synchroniseer
...
preferences-sync-reset-restore-to-server-yes = Data in Online Bibliotheek vervangen
