...
note-editor-highlight-text = Tekst markeren
note-editor-text-color = Text Color
note-editor-remove-color = Verwijder kleur
note-editor-bold = Vet
note-editor-italic = Cursief
note-editor-underline = Onderstrepen
...
note-editor-edit-in-window = In een afzonderlijk scherm bewerken
...
note-editor-image = Afbeelding
note-editor-math = Math
note-editor-table = Table
note-editor-citation = Verwijzing
