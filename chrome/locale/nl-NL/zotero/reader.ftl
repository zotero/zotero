...
reader-highlight-text = Tekst markeren
reader-underline-text = Underline Text
reader-add-note = Aantekening toevoegen
...
reader-clear-selection = Selectie wissen
...
reader-read-aloud-options = Opties
...
reader-read-aloud-error-unknown = Er is een onbekende fout opgetreden.
...
reader-read-aloud-annotation-popup-delete = Verwijder
reader-read-aloud-annotation-popup-done = Klaar
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Onderstrepen
