...
note-editor-paragraph = Málsgrein
...
note-editor-highlight-text = Auðkenna texta
note-editor-text-color = Text Color
note-editor-remove-color = Fjarlægja lit
note-editor-bold = Feitletur
note-editor-italic = Skáletur
note-editor-underline = Undirstrikað
note-editor-strikethrough = Strikethrough
note-editor-subscript = Lágvísir
note-editor-superscript = Hávísir
...
note-editor-image = Mynd
note-editor-math = Math
note-editor-table = Table
note-editor-citation = Tilvitnun
