...
reader-highlight-text = Auðkenna texta
reader-underline-text = Underline Text
reader-add-note = Bæta við athugasemd
...
reader-read-aloud-error-unknown = Óþekkt villa hefur komið upp.
...
reader-read-aloud-annotation-popup-delete = Eyða
...
reader-read-aloud-annotation-popup-underline = Undirstrikað
