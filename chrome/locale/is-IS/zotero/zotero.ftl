...
collections-menu-rename =
    .label = Rename
edit-saved-search = Breyta vistaðri leit
...
search-conditions-titleCreatorYear = Titill, höfundur, ár
search-conditions-submenu-attachment = Viðhengi
search-conditions-submenu-annotation = Skýring
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Skráartegund
...
search-conditions-short-annotationType = Tegund korts
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = Höfundur
...
mac-word-plugin-install-folder-dialog-button = Setja upp
...
save-search-edit-button =
    .label = Vista
save-search-name-title = Vista leit
...
undo-action-edit-note = Lagfæra athugasemd
...
undo-action-change-type = Breyta tegund færslu
