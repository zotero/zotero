...
search-conditions-submenu-attachment = Lampiran
search-conditions-submenu-annotation = Anotasi
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Jenis Berkas
...
search-conditions-short-annotationType = Jenis
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = Penulis
...
mac-word-plugin-install-folder-dialog-button = Instal
...
save-search-edit-button =
    .label = Simpan
save-search-name-title = Simpan pencarian
...
undo-action-edit-note = Edit Catatan
...
undo-action-change-type = Ubah Jenis Item
