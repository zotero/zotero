...
preferences-file-renaming-configure-button =
    .label = Uudelleennimeämisasetukset...
...
preferences-read-aloud-title = Lue ääneen
...
preferences-sync-data-syncing-description = Kirjaudu { -app-name }-tililläsi niin voit synkronoida tietosi laitteiden välillä ja muun muassa tehdä yhteistyötä muiden kanssa.
preferences-sync-settings-heading = Synkronointi
...
preferences-account-waiting-for-login =
    .value = Odotetaan sisäänkirjautumista...
preferences-account-cancel-button =
    .label = { general-cancel }
preferences-account-logged-out-status =
    .value = (kirjautunut ulos)
preferences-account-email-label =
    .value = Sähköposti:
preferences-account-switch-accounts =
    .label = Vaihda käyttäjää…
preferences-account-switch-text = Toiseen tiliin vaihtaminen poistaa kaiken { -app-name }n datan tältä tietokoneelta. Ennen kuin jatkat, tarkista että kaikki tärkeä data ja tiedostot on synkronoitu tilillä “{ $username }” tai sinulla on varmuuskopio { -app-name }n datakansiosta.
preferences-account-switch-confirmation-text = poista paikalliset tiedot
preferences-account-switch-accept = Poista tiedot ja käynnistä uudelleen
