...
reader-read-aloud-voice-tier-basic = Basic
reader-read-aloud-voice-tier-advanced = Advanced
...
reader-read-aloud-first-run-voice-tier-local-bullets = Voices provided by your operating system
    ...
    Free to use
reader-read-aloud-first-run-voice-tier-basic-bullets = Natural-sounding voices generated by AI models
    Only available with internet connection
    Only available when you are logged into your Zotero account
    Free to use
reader-read-aloud-first-run-voice-tier-advanced-bullets = Natural-sounding voices generated by AI models
    Only available with internet connection
    Only available when you are logged into your Zotero account
