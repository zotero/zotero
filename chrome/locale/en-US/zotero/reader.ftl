...
reader-read-aloud-first-run-voice-tier-local-bullets = Voices provided by your operating system
    ...
    Available without a { -app-name } account
    Free to use
reader-read-aloud-first-run-voice-tier-standard-bullets = Natural-sounding voices generated by AI models
    Only available with an internet connection
    Requires a { -app-name } account
    Limited language selection
    No multilingual support
    Source text doesn’t leave { -app-name } servers
    Unlimited use with a { -subscription-name } subscription
reader-read-aloud-first-run-voice-tier-premium-bullets = Highest-quality voices generated by AI models
    Only available with an internet connection
    Requires a { -app-name } account
