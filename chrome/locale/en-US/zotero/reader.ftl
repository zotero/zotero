...
reader-highlight-text = Highlight Text
reader-underline-text = Underline Text
reader-add-note = Add Note
...
reader-read-aloud-voice-mode-local = Local
reader-read-aloud-voice-mode-basic = Basic
reader-read-aloud-voice-mode-advanced = Advanced
...
reader-read-aloud-first-run-voice-mode-remote-bullets = Natural-sounding voices generated by AI models
...
reader-read-aloud-first-run-voice-mode-local-bullets = Voices provided by your operating system
    Available without internet connection
    Available without a Zotero account
    Free to use
reader-read-aloud-first-run-voice-mode-basic-bullets = Natural-sounding voices generated by AI models
    Only available with internet connection
    Only available when you are logged into your Zotero account
    Free to use
reader-read-aloud-first-run-voice-mode-advanced-bullets = Natural-sounding voices generated by AI models
    Only available with internet connection
    Only available when you are logged into your Zotero account
    <purchase-credits>Purchase credits</purchase-credits> for Read Aloud minutes
    If you subscribe to Zotero Storage, you get 60 credits each month
...
reader-read-aloud-voice-category-basic = Basic
reader-read-aloud-voice-category-advanced = Advanced
