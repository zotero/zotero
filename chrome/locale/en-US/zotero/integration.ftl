...
integration-editBibliography-add =
    .title = { general-add }
integration-editBibliography-revert =
    .title = Revert Edits
integration-editBibliography-add-to-bibliography =
    .aria-label = Add to Bibliography
integration-editBibliography-remove-from-bibliography =
