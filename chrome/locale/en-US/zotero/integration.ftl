...
first-run-guidance-citation-dialog = Type a title, author, and/or year to search for a reference.
    ...
    You can also add a locator directly by including it with your search terms (e.g. "history p. 10-15") or typing it after the bubble and pressing { return-or-enter }.
