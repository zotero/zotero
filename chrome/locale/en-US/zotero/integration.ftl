...
integration-citationDialog-lib-message-citation = { $search ->
...
integration-citationDialog-narrative-head-input =
    .placeholder = Head item
    .aria-description = Search for the item whose author appears in the text.
integration-citationDialog-narrative-infix-input =
    .placeholder = Infix (e.g. argues)
    .aria-label = Narrative citation infix
integration-citationDialog-narrative-remainder-input =
    .placeholder = Remainder items
    .aria-description = Search for items to include in the citation remainder.
