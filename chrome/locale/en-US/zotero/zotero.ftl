...
select-items-suggested-items = Suggested Items
select-items-library-column = Library
select-items-show-in-zotero =
    .label = { general-show-in-library }
...
mac-word-plugin-install-folder-dialog-button = Install
