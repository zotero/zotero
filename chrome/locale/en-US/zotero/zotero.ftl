...
context-notes-add-child-note =
    .label = Add Item Note
context-notes-add-child-note-from-annotations =
    .label = Add Item Note from Annotations
context-notes-add-standalone-note =
    .label = Add Standalone Note
