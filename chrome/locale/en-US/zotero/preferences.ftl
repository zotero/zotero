...
preferences-advanced-semantic-search-english =
    .label = English
preferences-advanced-semantic-search-chinese =
    .label = Chinese
...
preferences-advanced-semantic-search-progress-value = { $percent }% ({ $done } / { $total })
...
preferences-advanced-semantic-search-endpoint-error-not-embeddings = That URL isn’t an OpenAI-style embeddings endpoint.
