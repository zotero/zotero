...
preferences-locate-resolver = מפענח
...
-preferences-sync-data-syncing = סנכרון נתונים
...
preferences-sync-settings-heading = סנכרון
...
preferences-sync-reset-restore-to-server-yes = החלפת נתונים בספרייה מקוונת
