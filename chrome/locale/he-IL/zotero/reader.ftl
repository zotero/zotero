...
reader-read-aloud-options = אפשרויות
...
reader-read-aloud-language = שפה
...
reader-read-aloud-error-unknown = אירעה שגיאה בלתי ידועה.
...
reader-read-aloud-region-auto = אוטומטי
...
reader-read-aloud-annotation-popup-delete = מחיקה
reader-read-aloud-annotation-popup-done = בוצע
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = קו תחתי
