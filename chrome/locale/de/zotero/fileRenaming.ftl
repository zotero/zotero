...
file-renaming-auto-rename-prompt-body-library = Sollen bestehende Dateien in der Bibliothek "{ $library }" umgenannt werden, um den neuen Einstellungen zu entsprechen?
...
file-renaming-preview-window-intro-library = { -app-name } wird die folgenden Dateien in Ihrer "{ $library }" umbenennen, um sie an deren übergeordneten Einträge anzupassen:
