...
note-editor-highlight-text = Istakni tekst
note-editor-text-color = Text Color
note-editor-remove-color = Remove Color
note-editor-bold = Podebljano
note-editor-italic = Ukošeno
note-editor-underline = Podcrtano
note-editor-strikethrough = Strikethrough
note-editor-subscript = Indeks
note-editor-superscript = Eksponent
...
note-editor-edit-in-window = Uredi u odvojenom prozoru
