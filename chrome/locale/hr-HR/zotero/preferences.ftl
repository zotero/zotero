...
preferences-reader-ebook-font = Font e-knjige:
preferences-reader-ebook-hyphenate =
    .label = Enable automatic hyphenation
preferences-note-title = Bilješke
...
preferences-locate-resolver = Razrješivač:
...
preferences-advanced-server-enable-and-restart =
    .label = Omogući i ponovno pokreni
preferences-advanced-language-and-region-title = Jezik i regija
...
-preferences-sync-data-syncing = Sinkronizacija podataka
...
preferences-sync-settings-heading = Sinkroniziraj
