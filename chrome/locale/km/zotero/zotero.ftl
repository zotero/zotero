...
search-conditions-submenu-attachment = ឯកសារកម្ជាប់
search-conditions-submenu-annotation = ចំណារពន្យល់
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = ប្រភេទឯកសារ
...
search-conditions-short-annotationType = ប្រភេទ
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = អ្នកនិពន្ធ
...
mac-word-plugin-install-folder-dialog-button = ដំឡើង
...
save-search-edit-button =
    .label = Save
save-search-name-title = ទាញរក្សាទុកការស្រាវជ្រាវ
...
undo-action-edit-note = កែតម្រូវកំណត់ចំណាំ
...
undo-action-change-type = ផ្លាស់ប្តូរប្រភទឯកសារ
