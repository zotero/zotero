...
reader-highlight-text = បន្លិចពណ៌អត្ថបទ
reader-underline-text = Underline Text
reader-add-note = បន្ថែមកំណត់ចំណាំ
...
reader-read-aloud-language = ភាសា
...
reader-read-aloud-error-unknown = កំហុសមិនដឹងមូលហេតុបានកើតឡើង​។
...
reader-read-aloud-annotation-popup-delete = លុបចោល
...
reader-read-aloud-annotation-popup-underline = គូសបន្ទាត់ពីក្រោម
