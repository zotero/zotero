note-editor-set = Set
note-editor-more = ជម្រើសប្រភេទឯកសារផ្សេងៗ
...
note-editor-highlight-text = បន្លិចពណ៌អត្ថបទ
note-editor-text-color = Text Color
note-editor-remove-color = Remove Color
note-editor-bold = អក្សរដិត
note-editor-italic = អក្សរជ្រៀង
note-editor-underline = គូសបន្ទាត់ពីក្រោម
note-editor-strikethrough = Strikethrough
note-editor-subscript = អក្សរតូចក្រោម
note-editor-superscript = អក្សរតូចលើ
...
note-editor-image = រូបភាព
note-editor-math = Math
note-editor-table = Table
note-editor-citation = អាគតដ្ឋាន
