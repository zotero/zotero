...
file-renaming-format-title = Шаблон имени файла:
...
file-renaming-format-instructions-more = Смотрите <label data-l10n-name="file-renaming-format-help-link">документацию</label> для дополнительного информирования.
