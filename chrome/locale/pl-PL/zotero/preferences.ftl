...
preferences-read-aloud-highlight-granularity = Podświetl bieżący
...
preferences-sync-settings-heading = Synchronizacja
...
fulltext-index-status-complete = Indeks wyszukiwania jest aktualny
fulltext-stats-attachments-indexed = Zindeksowane załączniki:
fulltext-stats-partially-indexed = Częściowo zindeksowane:
fulltext-stats-not-available = Full-text content or file not available:
fulltext-stats-notes-indexed = Zindeksowane notatki:
