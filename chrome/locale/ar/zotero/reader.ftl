...
reader-read-aloud-options = خيارات
...
reader-read-aloud-error-unknown = حدث خطأ غير معروف.
...
reader-read-aloud-region-auto = تلقائي
...
reader-read-aloud-annotation-popup-delete = مسح
reader-read-aloud-annotation-popup-done = تم
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = تسطير
