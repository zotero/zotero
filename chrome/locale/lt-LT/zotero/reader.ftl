reader-annotations = Anotacijos
reader-show-annotations = Rodyti anotacijas
reader-search-annotations = Ieškoti anotacijų
reader-search-outline = Ieškoti žymelės
reader-no-annotations = Sukurkite anotaciją ir ją galėsite matyti šoniniame skydelyje.
reader-no-extracted-text = Tekstas neišgautas
reader-add-comment = Pridėti komentarą
reader-annotation-comment = Anotacijos komentaras
reader-annotation-text = Anotacijos tekstas
reader-manage-tags = Tvarkyti šios anotacijos gaires
reader-open-menu = Atverti anotacijos meniu
reader-thumbnails = Miniatiūros
reader-tag-selector-message = Atrinkti anotacijas pagal šią gairę
reader-add-tags = Pridėti gaires...
reader-highlight-text = Paryškinti tekstą
reader-underline-text = Pabraukti tekstą
reader-add-note = Įtraukti pastabą
reader-add-text = Pridėti tekstą
reader-select-area = Pažymėti sritį
reader-highlight-annotation = Paryškinimas
reader-highlight-annotation-short = Highlight
reader-underline-annotation = Pabraukimas
reader-underline-annotation-short = Pabraukimas
reader-note-annotation = Pastaba
reader-note-annotation-short = Pastaba
reader-text-annotation = Tekstinė anotacija
reader-text-annotation-short = Text
reader-image-annotation = Image Annotation
reader-image-annotation-short = Paveikslas
reader-ink-annotation = Ink Annotation
reader-ink-annotation-short = Ink
reader-search-result-index = Paieškos rezultatas
reader-search-result-total = Visi paieškos rezultatai
reader-draw = Piešti
reader-eraser = Trintukas
reader-pick-color = Pasirinkti spalvą
reader-add-to-note = Pridėti prie pastabos
reader-zoom-in = Priartinti
reader-zoom-out = Atitolinti
reader-zoom-reset = Numatytasis mastelis
reader-zoom-auto = Automatinis įtalpinimas
reader-zoom-page-width = Įtalpinti puslapio plotį
reader-zoom-page-height = Įtalpinti puslapio aukštį
reader-split-vertically = Skaidyti stačiai
reader-split-horizontally = Skaidyti gulsčiai
reader-next-page = Tolesnis puslapis
reader-previous-page = Ankstesnis puslapis
reader-page = Puslapis
reader-location = Vieta
reader-read-only = Tik skaityti
reader-prompt-transfer-from-pdf-title = Importuoti anotacijas
reader-prompt-transfer-from-pdf-text = Annotations stored in the PDF file will be moved to { $target }.
reader-prompt-password-protected = Operacija nepalaikoma slaptažodžiu apsaugotose PDF rinkmenose.
reader-prompt-delete-pages-title = Šalinti puslapius
...
reader-rotate-left = Pasukti kairėn
reader-rotate-right = Pasukti dešinėn
reader-edit-page-number = Keisti puslapio numerį...
reader-edit-annotation-text = Keisti anotacijos tekstą
reader-copy-image = Kopijuoti paveikslą
reader-save-image-as = Įrašyti paveikslėlį kaip...
reader-page-number-popup-header = Keisti puslapių numerius:
reader-this-annotation = šiai anotacijai
reader-selected-annotations = pasirinktoms anotacijoms
reader-this-page = šiam puslapiui
reader-this-page-and-later-pages = šiam ir tolesniems puslapiams
reader-all-pages = Visi puslapiai
reader-auto-detect = Aptikti automatiškai
reader-enter-password = Norėdami atverti šį PDF, įveskite slaptažodį
reader-include-annotations = Įtraukti anotacijas
reader-preparing-document-for-printing = Ruošiamasi spausdinti dokumentą...
reader-phrase-not-found = Sakinys nerastas
reader-find = Ieškoti
reader-close = Užverti
reader-show-thumbnails = Rodyti miniatiūras
reader-show-outline = Rodyti žymeles
reader-find-previous = Ieškoti teksto aukščiau
reader-find-next = Ieškoti teksto žemiau
reader-toggle-sidebar = Perjungti šoninę juostą
reader-find-in-document = Paieška dokumente
reader-toggle-context-pane = Perjungti kontekstinę sritį
reader-highlight-all = Viską paryškinti
reader-match-case = Skirti raidžių dydį
reader-whole-words = Pilni žodžiai
reader-appearance = Išvaizda
reader-epub-appearance-line-height = Eilutės aukštis
reader-epub-appearance-word-spacing = Tarpai tarp žodžių
reader-epub-appearance-letter-spacing = Tarpai tarp raidžių
reader-epub-appearance-page-width = Puslapio plotis
reader-epub-appearance-use-original-font = Naudoti pradinį šriftą
reader-epub-appearance-line-height-revert = Naudoti numatytąjį eilutės aukštį
reader-epub-appearance-word-spacing-revert = Naudoti numatytuosius tarpus tarp žodžių
reader-epub-appearance-letter-spacing-revert = Naudoti numatytuosius tarpus tarp raidžių
reader-epub-appearance-page-width-revert = Naudoti numatytąjį puslapio plotį
reader-convert-to-highlight = Paversti paryškinimu
reader-convert-to-underline = Paversti pabraukimu
reader-size = Dydis
reader-merge = Apjungti
reader-copy-link = Kopijuoti nuorodą
reader-theme-original = Pirminis
reader-theme-snow = Sniegas
reader-theme-sepia = Tamsiai rusvas
reader-theme-dark = Tamsus
reader-theme-black = juoda
reader-add-theme = Pridėti apipavidalinimą
reader-theme-invert-images = Invert Images
reader-scroll-mode = Slinktis
reader-spread-mode = Atlanka
reader-flow-mode = Puslapio išdėstymas
reader-columns = Stulpeliai
reader-split-view = Rodinio skaidymas
reader-themes = Apipavidalinimai
reader-vertical = Stačiai
reader-horizontal = Gulsčiai
reader-wrapped = Wrapped
reader-none = Jokio
reader-odd = Nelyginis
reader-even = Lyginis
reader-paginated = Puslapiuotas
reader-scrolled = Vientisas slenkamas
reader-single = Pavienis
reader-double = Dvigubas
...
reader-a11y-move-annotation = Spausdami rodyklių klavišus galite pastumti anotaciją.
...
reader-a11y-resize-annotation = Norėdami pakeisti tekstinės anotacijos dydį, laikykite { general-key-shift } ir spauskite rodyklių klavišus aukštyn arba žemyn.
reader-a11y-annotation-popup-appeared = Use Tab to navigate the annotation popup.
reader-a11y-annotation-created = { $type } sukurtas.
reader-a11y-annotation-selected = { $type } pasirinktas.
...
reader-import-from-epub-prompt-title = Importuoti el. knygos anotacijas
...
reader-import-from-epub-select-other = Pasirinkti kitą rinkmeną…
...
reader-read-aloud-options = Parinktys
...
reader-read-aloud-error-unknown = Įvyko nežinoma klaida.
...
reader-read-aloud-region-auto = Automatinis
...
reader-read-aloud-annotation-popup-delete = Pašalinti
reader-read-aloud-annotation-popup-done = Atlikta
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Pabraukimas
