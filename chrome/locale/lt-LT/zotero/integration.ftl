...
integration-citationDialog-section-selectedItems = Pasirinkti įrašai
...
integration-citationDialog-details-suppressAuthor = Praleisti autorių
...
integration-citationDialog-preview-empty = Peržiūra
...
integration-citationDialog-btn-type-citation =
    .title = Pridėti/redaguoti citavimą
integration-citationDialog-btn-type-add-note =
    .title = Įtraukti pastabą
