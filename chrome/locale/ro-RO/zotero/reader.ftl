...
reader-read-aloud-options = Opțiuni
...
reader-read-aloud-language = Limbă
...
reader-read-aloud-error-unknown = A intervenit o eroare necunoscută.
...
reader-read-aloud-region-auto = Automat
...
reader-read-aloud-annotation-popup-delete = Ștergere
reader-read-aloud-annotation-popup-done = Gata
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Subliniat
