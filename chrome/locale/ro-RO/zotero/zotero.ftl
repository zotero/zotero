...
collections-menu-rename =
    .label = Rename
edit-saved-search = Editează căutarea salvată
...
search-conditions-titleCreatorYear = Titlu, creator, an
search-conditions-submenu-attachment = Anexă
search-conditions-submenu-annotation = Adnotare
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = Tip de fișier
...
search-conditions-short-annotationType = Tip
...
mac-word-plugin-install-folder-dialog-button = Instalează
...
save-search-edit-button =
    .label = Salvează
save-search-name-title = Salvează căutarea
...
undo-action-edit-note = Editează notă
...
undo-action-change-type = Schimbă tipul înregistrării
