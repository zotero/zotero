preferences-window =
    .title = Arventennoù { -app-name }
preferences-appearance-title = Neuz ha yezh
preferences-auto-recognize-files =
    .label = Automatically retrieve metadata for PDFs and ebooks
preferences-file-renaming-title = Oc'h adenvel restroù
...
preferences-file-renaming-configure-button =
    .label = Kefluniañ an adenvel restroù...
preferences-attachment-titles-title = Titloù ar stagadennoù
...
preferences-reader-title = Lenner
preferences-reader-open-epubs-using = Digeriñ al levrioù elektronek gant
preferences-reader-open-snapshots-using = Digeriñ an tapadennoù gant
preferences-reader-open-in-new-window =
    .label = Digeriñ ar restroù en ur prenestr nevez e-plas ivinelloù
preferences-reader-auto-disable-tool =
    .label = Turn off note, text, and image annotation tools after each use
preferences-reader-ebook-font = Skritur al levrioù elektronek:
preferences-reader-ebook-hyphenate =
    .label = Enaouiñ an troc'hañ emgefreek
preferences-read-aloud-title = Lenn a vouezh uhel
...
preferences-color-scheme = Chema al livioù:
...
preferences-color-scheme-dark =
    .label = Teñval
preferences-item-pane-header = Talbenn ar banell elfenn:
preferences-item-pane-header-style = Stil an arroudenn talbenn:
preferences-item-pane-header-locale = Yezh an talbenn:
preferences-item-pane-header-missing-style = Stil a vank: <{ $shortName }>
...
preferences-locate-base-url = URL diazez:
...
preferences-advanced-server-enable-and-restart =
    .label = Enaouiñ hag adloc'hañ
preferences-advanced-language-and-region-title = Yezh ha rannvro
preferences-advanced-enable-bidi-ui =
    .label = Enable bidirectional text editing utilities
preferences-advanced-data-dir =
    .value = Kavlec'h roadennoù:
preferences-advanced-reset-data-dir =
    .label = Revert to Default Location…
preferences-advanced-custom-data-dir =
    .label = Implijout ul lec'hiadur personelaet...
preferences-advanced-default-data-dir =
    .value = (Dre ziouer: { $directory })
    .aria-label = Lec'hiadur dre ziouer
preferences-pane-account = Kont
...
preferences-sync-settings-heading = Sinkro
...
preferences-sync-reset-heading = Adloc'hañ sinkro
...
preferences-sync-reset-restore-to-server-confirmation-text = dilemel al levraoueg enlinenn
...
preferences-account-waiting-for-login =
    .value = O c'hortoz ur gevreadenn…
...
preferences-account-switch-confirmation-text = dilemel ar roadennoù lec'hel
preferences-account-switch-accept = Dilemel ar roadennoù hag adloc'hañ
