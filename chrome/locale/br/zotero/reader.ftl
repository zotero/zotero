reader-annotations = Ennotadurioù
reader-show-annotations = Diskouez an ennotadurioù
reader-search-annotations = Klask an ennotadurioù
reader-search-outline = Klask ezlinenn
reader-no-annotations = Krouiñ an ennotadurioù da welet anezhañ er banell-gostez
reader-no-extracted-text = Testenn ebet eztennet
reader-add-comment = Ouzhpennañ un evezhiadenn
...
reader-highlight-text = Usskediñ an destenn
reader-underline-text = Islinennañ an destenn
reader-add-note = Ouzhpennañ un notenn
...
reader-note-annotation-short = Notenn
...
reader-image-annotation-short = Skeudenn
...
reader-draw = Tresañ
reader-eraser = Gommenn
reader-pick-color = Diuzin ul liv
reader-add-to-note = Ouzhpennañ d'an notenn
reader-zoom-in = Zoumañ
reader-zoom-out = Dizoumañ
reader-zoom-reset = Adderaouiñ Zoom
reader-zoom-auto = Em-adventañ
reader-zoom-page-width = Zoumañ betek ledander ar bajenn
reader-zoom-page-height = Zoumañ betek uhelder ar bajenn
reader-split-vertically = Rannañ a-blom
reader-split-horizontally = Rannañ a-blaen
reader-next-page = Pajenn da-heul
reader-previous-page = Pajenn gent
reader-page = Pajenn
reader-location = Lec'hiadur
reader-read-only = Lenn hepken
reader-prompt-transfer-from-pdf-title = Emporzhiañ an ennotadurioù
...
reader-prompt-delete-pages-title = Dilemel ar pajennoù
...
reader-rotate-left = Treiñ a-gleiz
reader-rotate-right = Treiñ a-zehoù
reader-edit-page-number = Aozañ niver ar bajenn
reader-edit-annotation-text = Aozañ testenn an ennotadur
reader-copy-image = Eilañ ar skeudenn
reader-save-image-as = Enrollañ ar skeudenn evel...
reader-page-number-popup-header = Cheñch niver ar bajenn e:
reader-this-annotation = An ennotadurioù-mañ
reader-selected-annotations = Ennotadurioù diuzet
reader-this-page = Ar bajenn
reader-this-page-and-later-pages = Ar bajennad-mañ hag ar pajennadoù da-heul
reader-all-pages = An holl bajennoù
reader-auto-detect = Em-ziguzhiñ
reader-enter-password = Skrivit ar ger-tremen da zigeriñ ar restr PDF-mañ
reader-include-annotations = Enklozañ ennotadurioù
reader-preparing-document-for-printing = O prientiñ an teul da vezañ moullet...
reader-phrase-not-found = Frazenn nann-kavet
reader-find = Kavout
reader-close = Serriñ
...
reader-highlight-all = Usskediñ pep-tra
reader-match-case = Doujañ ouzh al log
reader-whole-words = Gerioù a-bezh
reader-appearance = Neuz
reader-epub-appearance-line-height = Uhelder al linenn
reader-epub-appearance-word-spacing = Spas etre gerioù
reader-epub-appearance-letter-spacing = Spas etre al lizherennoù
reader-epub-appearance-page-width = Ledander ar bajenn
reader-epub-appearance-use-original-font = Ober gant ar skritur orin
reader-epub-appearance-line-height-revert = Ober gant an uhelder linenn dre ziouer
reader-epub-appearance-word-spacing-revert = Ober gant ar spas dre ziouer etre ar gerioù
reader-epub-appearance-letter-spacing-revert = Ober gant ar spas dre ziouer etre al lizherennoù
reader-epub-appearance-page-width-revert = Ober gant al ledander pajenn dre ziouer
reader-convert-to-highlight = Emdreiñ da usskedet
reader-convert-to-underline = Emdreiñ da islinennet
reader-size = Ment
reader-merge = Kendeuziñ
reader-copy-link = Eilañ al liamm
reader-theme-original = Orin
reader-theme-snow = Erc'h
...
reader-themes = Temoù
reader-vertical = A-blom
reader-horizontal = A-blaen
reader-wrapped = Dre vloac'had
reader-none = Hini ebet
reader-odd = Par
reader-even = Ampar
reader-paginated = Pajennet
reader-scrolled = Dibunet
reader-single = Eeun
reader-double = Doubl
