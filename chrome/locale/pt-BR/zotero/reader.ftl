...
reader-show-annotations = Mostrar anotações
reader-search-annotations = Buscar anotações
reader-search-outline = Busca no sumário
reader-no-annotations = Criar uma anotação na barra lateral
reader-no-extracted-text = Texto não extraído
reader-add-comment = Adicionar comentário
reader-annotation-comment = Comentário da anotação
...
reader-highlight-text = Realçar texto
...
reader-underline-annotation-short = Sublinhado
...
reader-image-annotation-short = Imagem
...
reader-zoom-in = Aumentar o zoom
reader-zoom-out = Diminuir o zoom
reader-zoom-reset = Redefinir zoom
reader-zoom-auto = Zoom automático
reader-zoom-page-width = Largura da página
...
reader-next-page = Próxima página
...
reader-edit-page-number = Editar número de página...
...
reader-page-number-popup-header = Mudar número de página para:
reader-this-annotation = Esta anotação
reader-selected-annotations = Anotações selecionadas
reader-this-page = Esta página
reader-this-page-and-later-pages = Esta página e as próximas
reader-all-pages = Todas as páginas
reader-auto-detect = Autodetectar
...
reader-find-in-document = Procure no Documento
...
reader-import-from-epub-no-annotations-other-file =
    ...
    Se o e-book teve anotações com KOReader, tente selecionar o arquivo “metadata.epub.lua” diretamente.
...
reader-read-aloud-options = Opções
...
reader-read-aloud-error-unknown = Ocorreu um erro desconhecido.
...
reader-read-aloud-region-auto = Automático(a)
...
reader-read-aloud-annotation-popup-delete = Remover
reader-read-aloud-annotation-popup-done = Feito
reader-read-aloud-annotation-popup-change-color = Alterar cor
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Sublinhado
