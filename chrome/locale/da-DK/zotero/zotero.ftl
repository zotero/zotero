...
collections-menu-rename =
    .label = Rename
edit-saved-search = Rediger gemt søgning
...
search-conditions-titleCreatorYear = Titel, Ophav, År
search-conditions-submenu-attachment = Vedhæftning
search-conditions-submenu-annotation = Annotering
...
search-conditions-short-annotationAuthor = Forfatter/Ophav
...
mac-word-plugin-install-folder-dialog-button = Installér
...
save-search-edit-button =
    .label = Gem
save-search-name-title = Gem søgning
...
undo-action-edit-note = Redigér note
