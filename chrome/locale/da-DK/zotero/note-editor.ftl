...
note-editor-highlight-text = Marker tekst
note-editor-text-color = Text Color
note-editor-remove-color = Fjern farve
note-editor-bold = Fed
note-editor-italic = Kursiv
note-editor-underline = Understreg
note-editor-strikethrough = Strikethrough
note-editor-subscript = Sænket skrift
note-editor-superscript = Hævet skrift
...
note-editor-edit-in-window = Redigér i nyt vindue
...
note-editor-image = Grafik
note-editor-math = Math
note-editor-table = Table
note-editor-citation = Reference
