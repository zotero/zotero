...
reader-highlight-text = Marker tekst
reader-underline-text = Underline Text
reader-add-note = Tilføj note
...
reader-underline-annotation-short = Understreg
...
reader-image-annotation-short = Grafik
...
reader-zoom-in = Zoom ind
reader-zoom-out = Zoom ud
reader-zoom-reset = Reset zoom
reader-zoom-auto = Tilpas størrelse automatisk
reader-zoom-page-width = Zoom til sidens bredde
reader-zoom-page-height = Zoom til sidens højde
reader-split-vertically = Opdel lodret
reader-split-horizontally = Opdel vandret
...
reader-read-aloud-options = Indstillinger
...
reader-read-aloud-language = Sprog
...
reader-read-aloud-annotation-popup-delete = Slet
reader-read-aloud-annotation-popup-done = Færdig
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Understreg
