...
file-renaming-rename-linked =
    .label = Preimenuj povezane datoteke
...
file-renaming-format-template = Predloga imena datoteke:
file-renaming-format-preview = Predogled:
...
file-renaming-preview-window =
    .title = Rename Files
file-renaming-preview-window-loading = Nalaganje ...
