...
-integration-editBibliography-edit-reference = Za spreminjanje oblikovanja sklica uporabite urejevalnik besedil.
integration-editBibliography-wrapper =
    .aria-label = Pogovorno okno Uredi bibliografijo
    .aria-description =
...
integration-citationDialog-section-selectedItems = Izbrani vnosi
...
integration-citationDialog-details-suppressAuthor = Izpusti avtorja
...
integration-citationDialog-preview-empty = Predogled
...
integration-prefs-bookmarks =
    .label = Hrani citate kot zaznamke
