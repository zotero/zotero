...
collections-menu-rename =
    .label = Rename
edit-saved-search = แก้ไขบันทึกผลการค้นหา
...
advanced-search = ค้นหาแบบขั้นสูง
...
search-conditions-submenu-attachment = แฟ้มแนบ
search-conditions-submenu-annotation = ความเห็นประกอบ
search-conditions-short-fulltextContent = Content
search-conditions-short-fileTypeID = ประเภทแฟ้ม
...
search-conditions-short-annotationType = ประเภท
search-conditions-short-annotationColor = Color
search-conditions-short-annotationAuthor = ผู้แต่ง
...
mac-word-plugin-install-folder-dialog-button = ติดตั้ง
...
save-search-edit-button =
    .label = Save
save-search-name-title = บันทึกผลการค้นหา
...
undo-action-edit-note = แก้ไขบันทึก
...
undo-action-change-type = เปลี่ยนประเภทรายการ
