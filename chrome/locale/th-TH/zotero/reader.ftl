...
reader-highlight-text = เน้นข้อความให้เด่นชัด
reader-underline-text = Underline Text
reader-add-note = เพิ่มหมายเหตุ
...
reader-read-aloud-language = ภาษา
...
reader-read-aloud-error-unknown = พบความผิดพลาดที่ไม่ทราบที่มา
...
reader-read-aloud-annotation-popup-delete = ลบ
...
reader-read-aloud-annotation-popup-underline = ขีดเส้นใต้
