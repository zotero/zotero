...
export default function DeepTutorSubscriptionConfirm({ onClose, imagePath }) {
	...
	return (
		<div style={styles.container}>
			...
			<button style={styles.button} onClick={onClose}>Start Enjoying Your Benefits</button>
		</div>
	);
}

DeepTutorSubscriptionConfirm.propTypes = {

	/** Called when the user clicks the Start Using Premium button */
