...
export class CitationDialogHelpers {
	...
	// @param {string} string - The string to extract the locator from
	// @param {Boolean} options.bubbleJustAdded - true if a new bubble was just added
	extractLocator(string, options = {}) {
		string = string.trim();
		// special case: if a bubble was just added, treat plain numbers as a locator for page
		if (options.bubbleJustAdded && this.isOnlyNumberLocator(string)) {
			return { locator: string, label: "page", fullLocatorString: string, onlyLocator: true };
		}
