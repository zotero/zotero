		...
		return Zotero.Promise.coroutine(function* () {
			...
			if (selectedItems.length == 1) {
				...
				if (item.isCollection()) {
					...
					let msg = Zotero.getString('pane.collections.deletedCollection', subcollectionsCount);
					...
					let msg = Zotero.getString('pane.collections.deletedSearch', conditions, searchResultCount);
					this.setItemPaneMessage(msg);
				}
				else if (item.isNote()) {
