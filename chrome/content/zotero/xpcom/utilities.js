...
Zotero.Utilities = {
	 ...
	 * @param jsonld JSON-LD block
	 * @return {Promise<Array>}
	 */
	jsonldToQuads: async function (url, jsonld) {
		let documentLoader = async function (url, callback) {
			try {
		...
		return await Zotero.JSONLD.toRDF(jsonld, {base: url, documentLoader});
	},
