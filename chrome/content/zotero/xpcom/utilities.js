...
Zotero.Utilities = {
	...
	"determineAttachmentIcon":function(attachment) {
		...
		var type = Zotero.FileTypes.getFileTypeFromMIMEType(attachment.mimeType);
		if(!type || type == "webpage") type = "snapshot";
		
		return Zotero.ItemTypes.getImageSrc("attachment-" + type);
	},
