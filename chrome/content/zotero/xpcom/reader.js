		...
		this._internalReader = this._iframeWindow.wrappedJSObject.createReader(Components.utils.cloneInto({
			...
			onSaveCustomThemes: (customThemes) => {
				if (customThemes?.length) {
					Zotero.SyncedSettings.set(Zotero.Libraries.userLibraryID, 'readerCustomThemes', customThemes);
				}
				else {
					Zotero.SyncedSettings.clear(Zotero.Libraries.userLibraryID, 'readerCustomThemes');
				}
			},
