		...
		if(existingPage) {
			...
			CollectionList.getCollections(collectionID, libraryID).then(function(collections) {
				...
				page.on("pageinit", function() {
					Builder.collectionList(listview, collections, "append");
				});
...
$("#main-page").on("pageinit", function() {
	...
	Q.all([
		...
		Actions.resize(window.innerWidth,
			document.getElementById(header).clientHeight+document.getElementById("save").clientHeight);
	}).end();
});