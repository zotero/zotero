...
ZoteroAutoComplete.prototype.executeQuery = Zotero.Promise.coroutine(function* (queryID, searchString, searchParams) {
	...
	try {
		...
		yield Zotero.DB.queryAsync(sql, sqlParams, { onRow });
